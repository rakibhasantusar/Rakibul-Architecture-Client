        ...
        <section>
            <div className="dark:bg-black">
                <div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 dark:text-gray-900">
                    <h1 className="text-5xl font-bold leading-none sm:text-6xl xl:max-w-3xl dark:text-white">Best Architectural Design Service in Bangladesh</h1>
                    <p className="mt-6 mb-8 text-lg sm:mb-12 xl:max-w-3xl dark:text-white">I Provide Architectural Design, Interior Design, Landscape Design, Animation, Rajuk Sheet Design, Pauroshava Sheet Design, 3d Virtual Tour, Product Design!</p>
