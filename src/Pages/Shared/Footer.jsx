...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-black text-gray-300 ">
            <div>
                <img src={img} alt="logo" width="50" height="50" />
                <p className="font-bold">
                    RAKIBUL ARCHITECTURE <br />Providing reliable design service since 1992
                </p>
                <p>Rakibul_Architecture Copyright © 2022 - All right reserved</p>
            </div>
            <div>
