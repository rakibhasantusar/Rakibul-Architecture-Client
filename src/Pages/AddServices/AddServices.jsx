                            ...
                            <form onSubmit={handleAddService} className="space-y-8 ng-untouched ng-pristine ng-valid">
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <input type="text" name="title" placeholder="your service title" className="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-gray-300" />
                                    </div>
                                    <div className="space-y-2">
                                        <label className="block text-sm text-left">Your Service Photo Url</label>
                                        <input type="text" name="image" placeholder="your photo url" className="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-gray-300" />
                                    </div>
                                    <div className="space-y-2">
                                        <label className="block text-sm text-left">Your Service Price</label>
                                        <input type="number" name="price" placeholder="please give number digit" className="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-gray-300" />
                                    </div>
                                    <div className="space-y-2">
                                        <div className="flex justify-between">
                                            <label className="text-sm">Your Service Description</label>
                                        </div>
                                        <textarea type="text" name="description" placeholder="description here..." className="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-gray-300" />
                                    </div>
                                </div>
